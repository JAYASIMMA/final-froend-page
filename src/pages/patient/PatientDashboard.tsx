  ...
  return (
    <div className="animate-fade-in space-y-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold tracking-tight">Welcome, Jayasimma</h1>
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2 glass-card">
          ...
          <div className="space-y-4">
            {[
              { type: 'Skin Scan Sequence', result: '98% Confidence - Clear', date: 'Oct 12, 2024', status: 'Verified' },
              { type: 'Expert Consultation', result: 'Dr. Smith - SkinTermo Protocol', date: 'Oct 08, 2024', status: 'Completed' },
              { type: 'Skin Scan Sequence', result: 'Dermatitis Detected', date: 'Oct 01, 2024', status: 'Needs Review' },
            ].map((item, i) => (
